...
export const PLATFORM_OPTIONS: Record<Platform, AdOption[]> = {
  instagram: [
    ...
    { id: 'ig-post', name: 'Portrait Post', ratio: '4:5', dimensions: '1080x1350', description: 'Maximum feed vertical real estate.' },
  ...
  google: [
    ...
    { id: 'gg-portrait', name: 'Performance Max', ratio: '4:5', dimensions: '960x1200', description: 'Portrait for mobile browsing.' },
  ],
  'mercado-livre': [
